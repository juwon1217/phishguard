...
const KakaoDemo = () => {
  ...
  const handleStartSimulation = () => {
    const firstStrikes = {
      ...
      "가족/지인 사칭 (카톡 피싱)": "엄마/아빠, 나 핸드폰 액정이 깨져서 수리 맡겼어 ㅠㅠ 급하게 결제할 게 있는데 내 폰이 안 돼서... 확인하면 답장 좀!",
      "검찰청 수사관 (기관 사칭)": "본인 김주원 씨 맞습니까? 서울중앙지검 수사 1팀입니다. 본인 명의로 된 대포 통장이 범죄에 연루되어 연락드렸습니다."
    };
